...
public enum XChaCha20Poly1305Compat {
    ...
    public struct SealBox {
        public let ciphertext: Data
        public let tag: Data
    }

    public static func seal(plaintext: Data, key: Data, nonce24: Data, aad: Data? = nil) throws -> SealBox {
    ...
    public static func open(ciphertext: Data, tag: Data, key: Data, nonce24: Data, aad: Data? = nil) throws -> Data {
        guard key.count == 32 else {
            throw Error.invalidKeyLength(expected: 32, got: key.count)
        }
        guard nonce24.count == 24 else {
